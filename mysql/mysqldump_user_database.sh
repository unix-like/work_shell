...
function dump_db() {
  ...
  /gotwo_data/Application/mysql/bin/mysqldump -uroot -pxxxxxxxx $1 user > ${path}${file} && gzip ${path}${file} 
  #/gotwo_data/Application/mysql/bin/mysqldump -uroot -pxxxxxx $1 user  -t -T /tmp/ --fields-terminated-by=, --fields-enclosed-by=\" 
