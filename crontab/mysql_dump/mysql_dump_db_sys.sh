...
function dump_db() {
 ...
 /usr/bin/mysqldump -uroot -pXcQVr8CmHhs4FVN2 --socket /gotwo_data/mysql/dbGo2/socket/mysqld.sock --port 40003 --single-transaction  --ignore-table db_sys.sys_operator $1 > ${path}${file} && gzip ${path}${file} 
  # 删除超过7天的备份
